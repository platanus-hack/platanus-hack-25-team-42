      ...
      <div className="max-w-md w-full space-y-4 bg-white p-8 rounded-lg shadow-sm border border-gray-200">
                ...
                {requiredScopes.filter(
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="mt-4 w-full px-4 py-2 bg-yellow-700 text-white rounded-lg hover:bg-yellow-800 transition-colors"
                    >
        ...
        <div className="flex flex-col-reverse sm:flex-row sm:justify-end gap-3 mt-6">
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-yellow-700 hover:bg-yellow-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
